...
RENAMES = {
    ...
    # static: encoder
    "MT6816_MainLoop": "mt6816_main_loop",
    "MT6816_ProcessData": "mt6816_process_data",
    "MT6816_StartHighRead": "mt6816_start_high_read",
    "MT6816_StartLowRead": "mt6816_start_low_read",
    "MT6816_ParseAndCheck": "mt6816_parse_and_check",
    "MT6835_MainLoop": "mt6835_main_loop",
    "MT6835_StartRead": "mt6835_start_read",
    "MT6835_ParseAndCheck": "mt6835_parse_and_check",
    "AS5047_MainLoop": "as5047_main_loop",
    "AS5047_ProcessData": "as5047_process_data",
    "AS5047_StartCommand": "as5047_start_command",
    "AS5047_StartNOP": "as5047_start_nop",
    "AS5047_ParseAndCheck": "as5047_parse_and_check",
    "Common_AngleVelocityUpdate": "common_angle_velocity_update",
    "Encoder_PllUpdate": "encoder_pll_update",
    "Encoder_RecoverFromError": "encoder_recover_from_error",
    # static: flash
    "spi_Transmit_one_byte": "spi_transmit_one_byte",
    "spi_Receive_one_byte": "spi_receive_one_byte",
    "FLASH_ReadSR": "flash_read_sr",
    "FLASH_Enable": "flash_cs_enable",
    "FLASH_Disable": "flash_cs_disable",
    "FLASH_Wait_Busy": "flash_wait_busy",
    "FLASH_Write_Enable": "flash_write_enable",
    "FLASH_Write_Disable": "flash_write_disable",
    "fFLASH_WritePage": "flash_write_page",
    # static: foc
    "_FilterInit": "_filter_init",
    "_FocValReset": "_foc_val_reset",
    "_MotorInit": "_motor_init",
    "_ModeInit": "_mode_init",
    "_TrajectoryInit": "_trajectory_init",
    "_FrameDataDeal": "_frame_data_deal",
    "_process_pending_rx": "_process_pending_rx",
    "_stream_data_trans": "_stream_data_trans",
    "_AllLogSend": "_all_log_send",
    "_AllParamsSend": "_all_params_send",
    "_StatusSend": "_status_send",
    "_ToleranceCheck": "_tolerance_check",
    "_TuneJB": "_tune_jb",
    "_TunePsiF": "_tune_psi_f",
    "_TuneRs": "_tune_rs",
    "_TuneEncoder": "_tune_encoder",
    "_ParamReadFlash": "_param_read_flash",
    "_FitFromSums": "_fit_from_sums",
    # static: transforms
    "fClarkTransform": "clarke_transform",
    "fInvClarkTransform": "inv_clarke_transform",
    "fParkTransform": "park_transform",
    "fInvParkTransform": "inv_park_transform",
    # static: misc
    "vBubbleSort": "bubble_sort",
    "CAN_data_byte_deal": "can_data_byte_deal",
    "uartSendByte": "uart_send_byte",
    "uartSendData": "uart_send_data",
    "fNormalizeAngle_0_360": "normalize_angle_0_360",
    "fNormalizeAngle_180": "normalize_angle_180",
    "crc8_update": "crc8_update",
    "fFastRoundf": "fast_roundf",
}
