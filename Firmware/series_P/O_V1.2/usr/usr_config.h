...
#define FIRM_V_DATE    "O_V1.2_260506"
...
#define T_SAMPLE_us         7.0f
#define T_DEATH_us          0.5f
#define T_NOISE_us          0.5f

/* ---------- 速度 LPF 滤波器系数 (Butterworth) ---------- */
/* 速度 LPF — 2nd Order Butterworth LPF, fc=80.0Hz, fs=20000Hz */
#define LPF_W_B0    0.0001551484f
#define LPF_W_B1    0.0003102968f
#define LPF_W_B2    0.0001551484f
#define LPF_W_A1    1.9644605802f
#define LPF_W_A2    -0.9650811739f
