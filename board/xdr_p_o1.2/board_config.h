...
// ---------- 控制分频参数 ----------
#define FREQ_CURRENT        1       // 电流环分频 (1 = 每PWM周期执行)
#define FREQ_SPEED          10      // 速度环分频 (每FREQ_CURRENT*FREQ_SPEED = 10个PWM周期)
#define FREQ_POSITION       10      // 位置环分频 (每FREQ_SPEED*FREQ_POSITION = 100个PWM周期)
