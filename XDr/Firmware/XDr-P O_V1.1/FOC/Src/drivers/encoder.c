...
static void ENCODER_ProcessData(void)
{
    ...
    encoder.angle_abs = angle_raw * 0.000383495197f;  // 2^14 = 16384
    ...
    encoder.angle_inc = encoder.num_turns * MATH_2PI + encoder.angle_abs;
...
float fGetEncoderOmega(void) { return encoder.omega; }