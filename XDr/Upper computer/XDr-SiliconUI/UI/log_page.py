...
class LogPage():
    def __init__(self, main_window):
        ...
        self.loop_mode = SiCapsuleLineEdit()
        self.loop_mode.setReadOnly(True)
        self.loop_mode.resize(all_W, 40)
        self.loop_mode.setTitleWidthMode(SiCapsuleLineEdit.TitleWidthMode.Fixed)
        self.loop_mode.setTitleFixedWidth(title_W)
        self.loop_mode.setAlignment(Qt.AlignCenter)
        self.loop_mode.setTitle("环模式")
        ...
        log_show_layout1.addWidget(self.loop_mode)
