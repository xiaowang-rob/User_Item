...
class DataPage:
    def __init__(self, main_window):
        ...
        Title_pid = SiLabel()
        Title_pid.setStyleSheet("color:#E5E5E5;")
        Title_pid.setText("PID参数")
        Title_pid.setFont(SiFont.tokenized(GlobalFont.S_BOLD))
        Title_pid.setFixedHeight(18)
        Title_pid.setAlignment(Qt.AlignBottom)
        Title_pid.setSiliconWidgetFlag(Si.AdjustSizeOnTextChanged)
        ...
        self.traj_limit_d1 = SiCapsuleLineEdit()
        self.traj_limit_d1.resize(all_W, 40)
        self.traj_limit_d1.setTitleWidthMode(SiCapsuleLineEdit.TitleWidthMode.Fixed)
        self.traj_limit_d1.setTitleFixedWidth(title_W)
        self.traj_limit_d1.setAlignment(Qt.AlignCenter)
        self.traj_limit_d1.setTitle("一阶限幅")
        self.traj_limit_d1.setText("100")

        self.traj_limit_d2 = SiCapsuleLineEdit()
        self.traj_limit_d2.resize(all_W, 40)
        self.traj_limit_d2.setTitleWidthMode(SiCapsuleLineEdit.TitleWidthMode.Fixed)
        self.traj_limit_d2.setTitleFixedWidth(title_W)
        self.traj_limit_d2.setAlignment(Qt.AlignCenter)
        self.traj_limit_d2.setTitle("二阶限幅")
        self.traj_limit_d2.setText("50")

        self.traj_limit_d3 = SiCapsuleLineEdit()
        self.traj_limit_d3.resize(all_W, 40)
        self.traj_limit_d3.setTitleWidthMode(SiCapsuleLineEdit.TitleWidthMode.Fixed)
        self.traj_limit_d3.setTitleFixedWidth(title_W)
        self.traj_limit_d3.setAlignment(Qt.AlignCenter)
        self.traj_limit_d3.setTitle("三阶限幅")
        self.traj_limit_d3.setText("200")
        ...
        control_layout_scroll.addWidget(Title_pid)
        ...
        control_layout_scroll.addWidget(self.traj_limit_d1)
        control_layout_scroll.addWidget(self.traj_limit_d2)
        control_layout_scroll.addWidget(self.traj_limit_d3)
