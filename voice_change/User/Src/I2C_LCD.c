...
void lcd_send_cmd (char cmd,I2C_HandleTypeDef hi2c){	//0011 0000
...
void lcd_send_data (char data,I2C_HandleTypeDef hi2c){ //1111 0000
	char data_u, data_l;
	uint8_t i2c_frame_data[4];
	...
	if(HAL_I2C_Master_Transmit(&hi2c , SLAVE_ADDRESS_LCD, (uint8_t *) i2c_frame_data, 4, 100)!=HAL_OK) Error_Handler();
